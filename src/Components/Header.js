...
const Header = () => {
  ...
  const handleQueryBuilderContainer = (e) => {
  ...
  return (
    <div className='absolute opacity-100 w-full z-50 bg-gradient-to-b from-black flex justify-between'>
      ...
      { user && <div className='flex'>
        <button onClick={handleQueryBuilderContainer} className='p-2 bg-purple-900 rounded-lg text-white mt-4 mr-4 mb-4 '>{showSearch ? "Back to Home" : "Query Builder"}</button>
